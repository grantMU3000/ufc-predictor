...
def run(use_cache: bool = False) -> None:
    ...
    index = get_section_index("List_of_UFC_events", "Scheduled events", use_cache=use_cache)
    ...
    for event in resolved_events:
        ...
        card_wikitext = get_section_wikitext(event["name"], card_index, use_cache=use_cache)
